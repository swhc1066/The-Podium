...
//  The Podium
//
//  Created by Sean Craig on 2/25/15.
    ...
    override func viewDidLoad() {
        ...
        accountStore?.requestAccessToAccountsWithType(accountType, options: nil,
            ...
            if(granted)
            {
                ...
                {
                    var noAccountAlert : UIAlertController = UIAlertController(title: "No Accounts Found", message: "No Twitters accounts found.",
                        preferredStyle: UIAlertControllerStyle.Alert)
                    
                    var dismissButton : UIAlertAction = UIAlertAction(title: "Okay",
                        style:UIAlertActionStyle.Cancel) {
                        alert in
                        noAccountAlert.dismissViewControllerAnimated(true, completion: nil)
                    }
                    
                noAccountAlert.addAction(dismissButton)
